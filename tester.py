import random
from numpy import *
import linearegression as lr
import transfer as tra
...
def test1():
    ...
    r1 = lr.gradient_descent(train_x, train_y, alpha)
    print('-----')
    train_x, scaler, mode = lr.feature_scaling(train_x)
    r2 = lr.gradient_descent(train_x, train_y, alpha)
    print('----- scaler -----')
    print(scaler)
    return r1, r2
